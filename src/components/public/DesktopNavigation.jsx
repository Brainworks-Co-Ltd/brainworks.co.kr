          ...
          return (
            ...
            >
              <button
                ...
                className={`inline-flex items-center gap-1 rounded-full px-3 py-3 text-sm font-medium transition ${activeGroup === item.id || isOpen ? "bg-[var(--bw-color-surface-muted)] text-[var(--bw-color-ink)]" : "text-[var(--bw-color-muted)] hover:bg-[var(--bw-color-surface-muted)] hover:text-[var(--bw-color-ink)]"}`}
              >
                {item.label}
                <ChevronDown
                  aria-hidden="true"
